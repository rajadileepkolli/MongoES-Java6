...
/**
 * <p>
 * CustomDefaultDbRefResolver class.
 * </p>
 *
 * @author rajakolli
 * @version 1: 0
 */
public class CustomDefaultDbRefResolver implements DbRefResolver {
  ...
  /**
   * Creates a new {@link org.springframework.data.mongodb.core.convert.DefaultDbRefResolver} with the given
   * {@link org.springframework.data.mongodb.MongoDbFactory}.
   *
   * @param mongoDbFactory must not be {@literal null}.
   */
  public CustomDefaultDbRefResolver(MongoDbFactory mongoDbFactory) {
   ...
   * </p>
   *
   * @param dbRef a {@link com.mongodb.DBRef} object.
